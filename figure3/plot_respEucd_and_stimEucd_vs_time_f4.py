...
xlabel("time (ms)")
ylabel("stimulation and representation distance")
savefig("stim_and_resp_eucd_vs_time%d_%d_%d.jpg"%(tbgn,tend,plen))
savefig("stim_and_resp_eucd_vs_time%d_%d_%d.eps"%(tbgn,tend,plen))
show()
clf()
...
xlabel("time (ms)")
ylabel("stimulation and representation distance")
savefig("stim_and_resp_eucd_vs_time_fromOnset_%d_%d_%d.jpg"%(0,1000,plen))
savefig("stim_and_resp_eucd_vs_time_fromOnset_%d_%d_%d.eps"%(0,1000,plen))
show()
clf()
'''
