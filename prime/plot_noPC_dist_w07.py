...
print("this script plots fig as Fig.7cd in wilson2007")
...
def PC_dist(theCoup):
    ...
    for t in range(real_begin, real_end, 50):
        ...
        for i in idx:
            distls.append(norm(xtp[i[0]]-xtp[i[1]], 2))
        distls = sort(distls)
    ...
    return array(dist_t_avg_ls), array(dist_t_1q_ls), \
            array(dist_t_2q_ls), array(dist_t_3q_ls)
...
dist_t_avg_ls0, dist_t_1q_ls0, dist_t_2q_ls0, dist_t_3q_ls0 = PC_dist(0)
